...
/**
 * KSmartpay CC Types Source Model
 *
 * @category    Mage
 * @package     Mgf_KSmartpay
 * @author	   cherdchai Hinjumpa , bugcherd@gmail.com   089-003-5240
 * @website   http://magentothai.wordpress.com/
 */
class Mgf_KSmartpay_Model_Source_KSmartpaytype
{
    /**
    ...
    public function toOptionArray()
    {
        ...
        foreach (Mage::getSingleton('KSmartpay/config')->getKSmartpayTypes() as $code => $name) {
