 ...
 */
class Mageplace_Flippingbook_Block_Adminhtml_Magazine_Widget_Chooser extends Mage_Adminhtml_Block_Widget_Grid
{
	...
	public function prepareElementHtml(Varien_Data_Form_Element_Abstract $element)
	{
		...
		$sourceUrl = $this->getUrl('*/flippingbook_widget/chooser', array(
			'uniq_id' => $uniqId,
		));
        ...
        if ($element->getValue()) {
            $magazine = Mage::getModel('flippingbook/magazine')->load((int)$element->getValue());
            if ($magazine->getId()) {
	 ...
	 *
	 * @return Mageplace_Flippingbook_Block_Adminhtml_Magazine_Grid
	 */
	...
	{
		return $this->getUrl('*/flippingbook_widget/chooser',
			array(
				'_current' => true,
				'uniq_id' => $this->getId(),
			)
	 ...
	 * @return Mageplace_Flippingbook_Block_Adminhtml_Magazine_Widget_Chooser
	 */
