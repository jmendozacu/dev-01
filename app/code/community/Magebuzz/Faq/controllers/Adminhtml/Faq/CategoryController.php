 ...
 */
class Magebuzz_Faq_Adminhtml_Faq_CategoryController extends Mage_Adminhtml_Controller_action
{
    ...
    public function massStatusAction()
    {
        ...
        if (!is_array($faqIds)) {
            ...
            try {
                foreach ($faqIds as $faqId) {
                    $oldStores = Mage::getModel('faq/category')
                        ->load($faqId)->getResource()->lookupStoreIds($faqId);
                    $faq = Mage::getModel('faq/category')
                        ->load($faqId)
