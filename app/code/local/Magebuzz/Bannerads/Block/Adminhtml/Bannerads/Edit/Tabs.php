...
class Magebuzz_Bannerads_Block_Adminhtml_Bannerads_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs {
  ...
  protected function _beforeToHtml() {
    $this->addTab('form_section', array('label' => Mage::helper('bannerads')->__('Block Information'), 'title' => Mage::helper('bannerads')->__('Block Information'), 'content' => $this->getLayout()->createBlock('bannerads/adminhtml_bannerads_edit_tab_main')->toHtml(),));
    $this->addTab('form_banner_images', array(
