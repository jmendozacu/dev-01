...
class Magebuzz_Bannerads_Adminhtml_BanneradsController extends Mage_Adminhtml_Controller_action {
  ...
  protected function _initAction() {
    $this->loadLayout()->_setActiveMenu('bannerads/items')->_addBreadcrumb(Mage::helper('adminhtml')->__('Block Manager'), Mage::helper('adminhtml')->__('Block Manager'));
  ...
  public function exportCsvAction() {
    ...
    $content = $this->getLayout()->createBlock('bannerads/adminhtml_bannerads_grid')->getCsv();
  ...
  public function exportXmlAction() {
    ...
    $content = $this->getLayout()->createBlock('bannerads/adminhtml_bannerads_grid')->getXml();
