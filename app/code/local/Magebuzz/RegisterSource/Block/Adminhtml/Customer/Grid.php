<?php
class Magebuzz_RegisterSource_Block_Adminhtml_Customer_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns(){
        ...
        $this->addColumn('joycard', array(
            'header'    =>  Mage::helper('customer')->__('Joy Card'),
            'width'     =>  '100',
            'index'     =>  'joycard'
        ));
