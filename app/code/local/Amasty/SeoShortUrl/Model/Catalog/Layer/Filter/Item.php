 ...
 */
//if (Mage::helper('amseoshorturl')->isDeniedModule() && Mage::helper('amseoshorturl')->isModuleEnabled('MarginFrame_Shopby')) {
//    class Amasty_SeoShortUrl_Model_Catalog_Layer_Filter_Item extends Amasty_Shopby_Model_Catalog_Layer_Filter_Item {}
    class Amasty_SeoShortUrl_Model_Catalog_Layer_Filter_Item extends MarginFrame_Shopby_Model_Catalog_Layer_Filter_Item {}
//} else {
