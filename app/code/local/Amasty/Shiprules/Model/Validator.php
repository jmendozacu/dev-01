        ...
        foreach ($group as $item) {
            ...
            if ($item->getHasChildren() && $item->isShipSeparately()) {
                foreach ($item->getChildren() as $child) {
                    ...
                    $totals['not_free_price'] += $includeTax ? $child->getBasePriceInclTax() :$child->getBasePrice() * $notFreeQty;
                ...
                $totals['not_free_price'] += $includeTax ? $item->getBasePriceInclTax() :$item->getBasePrice() * $notFreeQty;
