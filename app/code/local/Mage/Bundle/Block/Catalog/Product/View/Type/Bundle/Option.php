...
class Mage_Bundle_Block_Catalog_Product_View_Type_Bundle_Option extends Mage_Bundle_Block_Catalog_Product_Price
{
    ...
    {
        $formattedPrice = Mage::helper('core')->currency($_selection->getFinalPrice(), true, false);
        ...
        $priceTitle .= ' &nbsp; ' . ($includeContainer ? '<span class="price-notice">' : '')
            . '+' . $this->formatPriceString($price, $includeContainer)
            . ($includeContainer ? '</span>' : '');
        $priceTitle .= '<div class="product-sku">'.
          '<span>'.$this->__('SKU :').'</span>'.
          '<span id="product-sku"> '.$this->escapeHtml($_selection->getSku()).'</span>
                </div>';
        $priceTitle .= '<div class="product-sku">'.
          '<span>'.$this->__('Price :').'</span>'.
          '<span id="product-sku"> '.$formattedPrice.'</span>
                </div>';
        return $priceTitle;
    }
