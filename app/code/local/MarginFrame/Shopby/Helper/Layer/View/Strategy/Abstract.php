...
abstract class MarginFrame_Shopby_Helper_Layer_View_Strategy_Abstract
{
    /** @var Mage_Catalog_Block_Layer_Filter_Abstract */
    protected $filter;

    /** @var MarginFrame_Shopby_Block_Catalog_Layer_View */
    protected $layer;
    ...
    public function setLayer(MarginFrame_Shopby_Block_Catalog_Layer_View $layer)
    {
        $this->layer = $layer;
    }
