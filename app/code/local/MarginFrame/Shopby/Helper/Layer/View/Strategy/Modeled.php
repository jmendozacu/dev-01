...
abstract class MarginFrame_Shopby_Helper_Layer_View_Strategy_Modeled extends MarginFrame_Shopby_Helper_Layer_View_Strategy_Abstract
{
    ...
    protected function getFilterModel()
    {
        ...
        /** @var MarginFrame_Shopby_Model_Filter $model */
