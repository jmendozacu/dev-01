...
class MarginFrame_Shopby_Helper_Data extends MarginFrame_Shopby_Helper_Cached
{
    protected $_useSolr;
    ...
    /**
     * @return MarginFrame_Shopby_Model_Filter[]
     */
     ...
     * @param MarginFrame_Shopby_Block_Catalog_Layer_Filter_Attribute $filter
     *          - used in app/design/frontend/base/default/template/marginframe/amshopby/view_top.phtml
     */
    public function getAttributePosition($filter)
    {
        ...
        if( $filter instanceof MarginFrame_Shopby_Block_Catalog_Layer_Filter_Rating ){
    ...
    public function getIconsData()
    {
        ...
        $result = array();
        /** @var MarginFrame_Shopby_Helper_Url $hlp */
        $hlp = Mage::helper('amshopby/url');
        foreach ($optionCollection as $opt){
            /** @var MarginFrame_Shopby_Model_Value $opt */
    ...
    public function showLinks($product, $mode='view', $names=array(), $exclude=false)
    {
        ...
        usort($items, array('MarginFrame_Shopby_Helper_Data', '_srt'));
        
        //create block
        $block = Mage::getModel('core/layout')->createBlock('core/template')
            ->setArea('frontend')
            ->setTemplate('marginframe/amshopby/links.phtml');
    ...
    {
        return $this->isModuleEnabled('MarginFrame_Xlanding') && Mage::app()->getRequest()->getParam('am_landing');
    }
    ...
    {
        $settings = $this->getAttributesSettings();
        /** @var MarginFrame_Shopby_Helper_Attributes $attributeHelper */
    ...
    protected function getMultiselectAttributeCodes()
    {
        ...
        /** @var MarginFrame_Shopby_Helper_Attributes $attributesHelper */
    ...
    public function getCategoriesMultiselectMode()
    {
        ...
        && Mage::getStoreConfig('amshopby/general/categories_type') == MarginFrame_Shopby_Model_Catalog_Layer_Filter_Category::DT_DEFAULT;
    }
