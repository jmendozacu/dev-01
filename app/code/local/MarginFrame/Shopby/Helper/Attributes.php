 ...
 */
class MarginFrame_Shopby_Helper_Attributes extends MarginFrame_Shopby_Helper_Cached
{
    protected $_options;
    ...
    public function getAllFilterableOptionsAsHash()
    {
        ...
        $requireUniqueOptions = Mage::getStoreConfig('amshopby/seo/hide_attributes') || Mage::getStoreConfig('amshopby/seo/urls') == MarginFrame_Shopby_Model_Source_Url_Mode::MODE_SHORT;
