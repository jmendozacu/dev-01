 ...
 */
class MarginFrame_Shopby_Helper_Url extends Mage_Core_Helper_Abstract
{
    ...
    public function getCanonicalUrl()
    {
        ...
        switch ($canonicalType) {
            case MarginFrame_Shopby_Model_Source_Canonical::CANONICAL_KEY:
                return $category ? $category->getUrl() : (Mage::getBaseUrl() . $key);

            case MarginFrame_Shopby_Model_Source_Canonical::CANONICAL_CURRENT_URL:
                return $this->_getCurrentUrlWithoutParams();

            case MarginFrame_Shopby_Model_Source_Canonical::CANONICAL_FIRST_ATTRIBUTE_VALUE:
    ...
    protected function _getFirstAttributeValueUrl()
    {
        ...
        /** @var MarginFrame_Shopby_Helper_Data $dataHelper */
    ...
    /**
     * @deprecated Now it is a facade to MarginFrame_Shopby_Model_Url
     */
    public function getFullUrl($query=array(), $clear=false, $cat = null)
    {
        /** @var MarginFrame_Shopby_Model_Url_Builder $builder */
