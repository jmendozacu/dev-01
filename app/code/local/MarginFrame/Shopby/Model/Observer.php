 ...
 */
class MarginFrame_Shopby_Model_Observer
{
    public function handleControllerFrontInitRouters($observer)
    {
        $observer->getEvent()->getFront()
            ->addRouter('amshopby', new MarginFrame_Shopby_Controller_Router());
    }
...
//        $html = str_replace('is_ajax=1&', '', $html);
    ...
    {
        /** @var MarginFrame_Shopby_Model_Mysql4_Filter_Collection $filterCollection */
