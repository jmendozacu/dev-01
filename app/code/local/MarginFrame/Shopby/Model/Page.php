...
/**
 * @method MarginFrame_Shopby_Model_Page setCond($serializedCond)
 * @method string getCond()
 * @method MarginFrame_Shopby_Model_Page setCats($cats)
 * @method string getCats()
 * @method int getCmsBlockId
 * @method string getMetaDescr()
 * @method string getMetaKw()
 * @method string getMetaTitle()
 * @method MarginFrame_Shopby_Model_Page setUrl(string $url)
 * @method string getTitle()
 * @method string getUrl()
 * @method boolean getUseCat()
 */
class MarginFrame_Shopby_Model_Page extends Mage_Core_Model_Abstract
{
