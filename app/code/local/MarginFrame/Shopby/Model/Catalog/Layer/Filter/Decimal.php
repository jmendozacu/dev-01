...
class MarginFrame_Shopby_Model_Catalog_Layer_Filter_Decimal extends MarginFrame_Shopby_Model_Catalog_Layer_Filter_Decimal_Adapter
{
     ...
     *
     * @return MarginFrame_Shopby_Model_Mysql4_Decimal
     */
    ...
    {
        $settings = $this->getSettings();
        return $settings['display_type'] == MarginFrame_Shopby_Model_Catalog_Layer_Filter_Price::DT_DEFAULT
        || $settings['display_type'] == MarginFrame_Shopby_Model_Catalog_Layer_Filter_Price::DT_DROPDOWN;
    } 
    ...
    public function hideAfterSelection()
    {
        ...
        if ($settings['display_type'] == MarginFrame_Shopby_Model_Catalog_Layer_Filter_Price::DT_SLIDER){
            return false;
        }
        return true;
    }
