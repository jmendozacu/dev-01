...
class MarginFrame_Shopby_Model_Catalog_Layer_Filter_Price_Price17ce extends MarginFrame_Shopby_Model_Catalog_Layer_Filter_Price_Price17ce_Parent
{
    public function apply(Zend_Controller_Request_Abstract $request, $filterBlock)
    {
         ...
         */
        $isSlider = Mage::getStoreConfig('amshopby/general/price_type') == MarginFrame_Shopby_Model_Catalog_Layer_Filter_Price::DT_SLIDER;
        ...
        /** @var MarginFrame_Shopby_Helper_Attributes $attrHelper */
     ...
     *
     * @return MarginFrame_Shopby_Model_Mysql4_Price17
     */
