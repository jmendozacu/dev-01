 ...
 */
class MarginFrame_Shopby_Model_Catalog_Layer_Filter_Category extends MarginFrame_Shopby_Model_Catalog_Layer_Filter_Category_Adapter
{
    /**
     * Display Types
     */
    ...
    /** @var  MarginFrame_Shopby_Model_Url_Builder */
    ...
    public function getAdvancedCollection()
    {
        if (is_null($this->_advancedCollection)) {
            ...
            switch ($startFrom) {
                case MarginFrame_Shopby_Model_Source_Category_Start::START_CHILDREN:
                    break;
                case MarginFrame_Shopby_Model_Source_Category_Start::START_CURRENT:
                    $parent = $category->getParentCategory();
                    if ($parent) {
                        $category = $parent;
                    }
                    break;
                case MarginFrame_Shopby_Model_Source_Category_Start::START_ROOT:
                default:
