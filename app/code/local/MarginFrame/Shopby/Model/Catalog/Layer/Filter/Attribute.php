...
/**
 * Class MarginFrame_Shopby_Model_Catalog_Layer_Filter_Attribute
 * @method Mage_Catalog_Model_Resource_Eav_Attribute getAttributeModel()
 */
class MarginFrame_Shopby_Model_Catalog_Layer_Filter_Attribute extends MarginFrame_Shopby_Model_Catalog_Layer_Filter_Attribute_Adapter
{
    ...
    public function apply(Zend_Controller_Request_Abstract $request, $filterBlock)
    {
        ...
        if ($currentVals) {
            ...
            $branding = $controller == 'MarginFrame_Shopby'
                && count($currentVals) == 1
    ...
    protected function addState($currentVals)
    {
        ...
        /** @var MarginFrame_Shopby_Model_Catalog_Layer_Filter_Item $state */
    ...
    protected function getSingleChoice()
    {
        ...
        return ($settings->getDisplayType() == MarginFrame_Shopby_Model_Source_Attribute::DT_DROPDOWN) ? true : $settings->getSingleChoice();
    }
