...
class MarginFrame_Shopby_Model_Catalog_Layer_Filter_Rating extends Mage_Catalog_Model_Layer_Filter_Abstract
{
    ...
    protected function getLabelHtml($countStars)
    {
        ...
        $html = $block->setTemplate('marginframe/amshopby/rating.phtml')->toHtml();
        return $html;
    }
