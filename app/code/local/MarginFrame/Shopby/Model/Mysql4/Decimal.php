 ...
 */ 
class MarginFrame_Shopby_Model_Mysql4_Decimal extends Mage_Catalog_Model_Resource_Eav_Mysql4_Layer_Filter_Decimal 
{
    protected $_minMax = null;

    /**
     * @param MarginFrame_Shopby_Model_Catalog_Layer_Filter_Decimal $filter
     * @param float $from
     * @param float $to
    ...
    protected function _applyFilterToCollectionDb($filter, $from, $to)
    {
		...
		$isSlider = (isset($settings['display_type']) && $settings['display_type'] == MarginFrame_Shopby_Model_Catalog_Layer_Filter_Price::DT_SLIDER);
