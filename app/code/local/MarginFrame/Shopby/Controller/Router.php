 ...
 */
class MarginFrame_Shopby_Controller_Router extends Mage_Core_Controller_Varien_Router_Abstract
{
    const MIDDLE    = 0;
    const BEGINNING = 1;
    ...
    public function match(Zend_Controller_Request_Http $request)
    {
        ...
        if (!$isMatched && $this->urlMode == MarginFrame_Shopby_Model_Source_Url_Mode::MODE_SHORT) {
    ...
    protected function matchForwardShort()
    {
        ...
        /** @var MarginFrame_Shopby_Model_Url_Parser $shortParser */
    ...
    protected function matchForwardMultilevel()
    {
        ...
        if ($this->urlMode == MarginFrame_Shopby_Model_Source_Url_Mode::MODE_SHORT && Mage::getStoreConfig('amshopby/seo/redirects_enabled')) {
