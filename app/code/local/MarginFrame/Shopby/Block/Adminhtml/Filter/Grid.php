 ...
 */
class MarginFrame_Shopby_Block_Adminhtml_Filter_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        /** @var MarginFrame_Shopby_Model_Source_Position $positionSource */
