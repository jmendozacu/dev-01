 ...
 */
class MarginFrame_Shopby_Block_Adminhtml_Filter_Edit_Tab_General extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * Filter form
    ...
    /** @var  MarginFrame_Shopby_Model_Filter */
    protected $model;
    ...
    protected function _prepareFieldsetBlocks()
    {
        ...
        $fldSet2->addField('show_on_view', 'select', array(
            ...
            'name'      => 'show_on_view',
            'values'    => $this->yesno,
            'note'      => $this->__('Show options images block on product view page. You need to perform modifications in theme template, see MarginFrame Improved Navigation User Guide on page 15.'),
        ));
    }
    ...
    protected function setupDependencies()
    {
        ...
        if ($this->isDecimal()) {
            $mapper
                ...
                ->addFieldDependence('slider_type', 'display_type', MarginFrame_Shopby_Model_Catalog_Layer_Filter_Price::DT_SLIDER)
                ->addFieldDependence('slider_decimal', 'display_type', MarginFrame_Shopby_Model_Catalog_Layer_Filter_Price::DT_SLIDER)
                ;
        } else {
            $mapper
