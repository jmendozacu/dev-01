...
class MarginFrame_Shopby_Block_Catalog_Layer_Filter_Rating extends Mage_Catalog_Block_Layer_Filter_Abstract
{
    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('marginframe/amshopby/attribute.phtml');
