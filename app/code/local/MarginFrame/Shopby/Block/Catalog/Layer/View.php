...
class MarginFrame_Shopby_Block_Catalog_Layer_View extends MarginFrame_Shopby_Block_Catalog_Layer_View_Adapter
{
    ...
    public function getFilters()
    {
        ...
        /** @var MarginFrame_Shopby_Block_Catalog_Layer_Filter_Rating $f */
        ...
        foreach ($filters as $f){
            ...
            if (is_object($strategy)) {
                ...
                if ($strategy instanceof MarginFrame_Shopby_Helper_Layer_View_Strategy_Attribute) {
    ...
    {
        $strategyCode = null;
        if ($filter instanceof MarginFrame_Shopby_Block_Catalog_Layer_Filter_Stock) {
            $strategyCode = 'stock';
        }
        ...
        else if ($filter instanceof MarginFrame_Shopby_Block_Catalog_Layer_Filter_Rating) {
            $strategyCode = 'rating';
        }

        /** @var MarginFrame_Shopby_Helper_Layer_View_Strategy_Abstract|null $strategy */
        if ($strategyCode) {
    ...
    {
        /** @var MarginFrame_Xlanding_Model_Page $landingPage */
    ...
    public function getStateHtml()
    {
        ...
        $this->getChild('layer_state')->setTemplate('marginframe/amshopby/state.phtml');
    ...
    protected function _prepareLayout()
    {
        ...
        if ($head){
            $head->addJs('marginframe/amshopby/amshopby.js');

            if (Mage::getStoreConfig('amshopby/block/slider_use_ui')) {
                $head->addJs('marginframe/amshopby/jquery.min.js');
                $head->addJs('marginframe/amshopby/jquery-ui.min.js');
                $head->addJs('marginframe/amshopby/jquery.ui.touch-punch.min.js');
                $head->addJs('marginframe/amshopby/amshopby-jquery.js');
            }
            ...
            if (Mage::getStoreConfigFlag('amshopby/block/ajax')){
                ...
                if (!$isProductPage)
                $head->addJs('marginframe/amshopby/amshopby-ajax.js');                 
            }
        }
    ...
    protected function _notInBlock($pos)
    {
        ...
        return (!in_array($pos, array($this->_blockPos, MarginFrame_Shopby_Model_Source_Position::BOTH)));
    }
    ...
    {
        /** @var MarginFrame_Shopby_Helper_Url $helper */
