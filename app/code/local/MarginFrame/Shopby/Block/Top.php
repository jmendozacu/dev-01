 ...
 */
class MarginFrame_Shopby_Block_Top extends Mage_Core_Block_Template
{
    ...
    /**
     * @param MarginFrame_Shopby_Model_Page|null $page
     */
    ...
    {
        /** @var MarginFrame_Shopby_Model_Mysql4_Page $pageResource */
    ...
    protected function _prepareLayout()
    {
        ...
        /** @var MarginFrame_Shopby_Block_Catalog_Product_List_Toolbar $toolbar */
        $toolbar = $this->getLayout()->getBlock('product_list_toolbar');
        if ($toolbar instanceof MarginFrame_Shopby_Block_Catalog_Product_List_Toolbar) {
        ...
        foreach ($filters as $f){
            /** @var MarginFrame_Shopby_Model_Filter $f */
    ...
    protected function changeCategoryData(Mage_Catalog_Model_Category $category)
    {
        ...
        if ($descriptions && $position != MarginFrame_Shopby_Model_Source_Description_Position::DO_NOT_ADD) {
            $oldDescription = $category->getData('description');
            $description = '<span class="amshopby-descr">' . join('<br>', $descriptions) . '</span>';
            switch ($position) {
                case MarginFrame_Shopby_Model_Source_Description_Position::AFTER:
                    $description = $oldDescription ? $oldDescription . '<br>' . $description : $description;
                    break;
                case MarginFrame_Shopby_Model_Source_Description_Position::BEFORE:
                    $description = $oldDescription ? $description . '<br>' . $oldDescription : $description;
                    break;
                case MarginFrame_Shopby_Model_Source_Description_Position::REPLACE:
                    break;
            }
    ...
    /**
     * @return MarginFrame_Shopby_Model_Value|null
     */
    protected function getCurrentBrandPageBrand()
    {
        ...
        /** @var MarginFrame_Shopby_Helper_Attributes $helper */
    ...
    {
        if ($newParts && $position != MarginFrame_Shopby_Model_Source_Description_Position::DO_NOT_ADD) {
            if ($original) {
                switch ($position) {
                    case MarginFrame_Shopby_Model_Source_Description_Position::AFTER:
