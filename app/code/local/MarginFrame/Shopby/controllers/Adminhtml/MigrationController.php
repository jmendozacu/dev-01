 ...
 */
class MarginFrame_Shopby_Adminhtml_MigrationController extends Mage_Adminhtml_Controller_Action
{
    // show grid
    public function indexAction()
    {
        ...
        $this->_addContent($this->getLayout()->createBlock('amshopby/adminhtml_migrations')->setTemplate('marginframe/amshopby/migrations.phtml'));
