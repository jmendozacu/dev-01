...
class MarginFrame_Dataflow_Model_Observer_Cron
    extends Mage_Cron_Model_Observer
{
    ...
    public function dispatch(Varien_Event_Observer $observer)
    {
        ...
        foreach ($schedules->getIterator() as $schedule) {
            /** @var MarginFrame_Dataflow_Model_Profile_Schedule $schedule */
...
//        }
        ...
        /** @var MarginFrame_Dataflow_Model_Profile_Schedule $schedule */
        $schedule = Mage::getModel('marginframe_dataflow/profile_schedule');
    ...
    /**
     * @return MarginFrame_Dataflow_Model_Resource_Profile_Import_Collection
     */
    public function getAvailableProfiles()
    {
        /** @var MarginFrame_Dataflow_Model_Resource_Profile_Import_Collection $profileCollection */
        $profileCollection = Mage::getResourceModel('marginframe_dataflow/profile_import_collection');
    ...
    /**
     * @return MarginFrame_Dataflow_Model_Resource_Profile_Schedule_Collection
     */
    public function getPendingSchedules()
    {
        if (!$this->_pendingSchedules) {
            $this->_pendingSchedules = Mage::getResourceModel('marginframe_dataflow/profile_schedule_collection');
    ...
    public function cleanup()
    {
        ...
        /** @var MarginFrame_Dataflow_Model_Resource_Profile_Schedule_Collection $collection */
    ...
    /**
     * @param MarginFrame_Dataflow_Model_Profile_Schedule $schedule
     */
    protected function _execute(MarginFrame_Dataflow_Model_Profile_Schedule $schedule)
    {
        /** @var MarginFrame_Dataflow_Model_Profile_Import $profile */
        $profile  = Mage::getModel('marginframe_dataflow/profile_import')->load($schedule->getData('profile_id'));
