...
class MarginFrame_Dataflow_Model_Import_Adapter_Type_Product_Data_Price
                ...
                foreach ($groupPrices as $groupPrice) {
                    ...
                    if ((count($websites) == 1) || ($groupPrice[1] == self::ALL_WEBSITES)) {
                        ...
                        if (!isset($websites[$groupPrice[1]])) {
                            throw new MarginFrame_Dataflow_Model_Import_Adapter_Exception(sprintf('Webiste %s doesn\'t exists', $groupPrice[1]));
                        }
                        $websiteId = $websites[$groupPrice[1]];
                    }
                    if (!isset($this->_customerGroups[$groupPrice[0]])) {
                        throw new MarginFrame_Dataflow_Model_Import_Adapter_Exception(sprintf('Customer Group %s doesn\'t exists', $groupPrice[0]));
                    }
                    $values = array(
                ...
                foreach ($tierPrices as $tierPrice) {
                    ...
                    if ((count($websites) == 1) || ($tierPrice[1] == self::ALL_WEBSITES)) {
                        ...
                        if (!isset($websites[$tierPrice[1]])) {
                            throw new MarginFrame_Dataflow_Model_Import_Adapter_Exception(sprintf('Webiste %s doesn\'t exists', $tierPrice[1]));
                        }
                    ...
                    if ($tierPrice[0] == self::ALL_GROUPS) {
                        ...
                        if (!isset($this->_customerGroups[$tierPrice[0]])) {
                            throw new MarginFrame_Dataflow_Model_Import_Adapter_Exception(sprintf('Customer Group %s doesn\'t exists', $tierPrice[0]));
                        }
