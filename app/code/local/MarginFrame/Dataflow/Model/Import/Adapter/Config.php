...
class MarginFrame_Dataflow_Model_Import_Adapter_Config
{
    /** @var  int */
    ...
    protected $_store;
    /** ipune @var  string  */
    protected $_optionImagePath;
    /** ipune @var  bool  */
    protected $_canCreateUrlkey = false;

    public function __construct(array $attributeCodes)
    {
        if (empty($attributeCodes)) {
            throw new MarginFrame_Dataflow_Exception(
                Mage::helper('marginframe_dataflow')->__('Please specify attributes.'));
        }
     ...
     * @return $this
     */
    public function setOptionImagePath($imagePath)
    {
    	if (!empty($imagePath)) {
    		$this->_optionImagePath = $imagePath;
    	}
     ...
     * @return $this
     */
    public function setCanCreateUrlkey($flag)
    {
        $this->_canCreateUrlkey = (bool) $flag;
     ...
     * @return bool
     */
    public function getCanCreateUrlkey()
    {
    	return $this->_canCreateUrlkey;
    }
