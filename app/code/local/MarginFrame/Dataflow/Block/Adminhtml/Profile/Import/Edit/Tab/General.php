...
class MarginFrame_Dataflow_Block_Adminhtml_Profile_Import_Edit_Tab_General
    ...
    protected function _prepareLayout()
    {
        ...
        function switchScopeView(scope) {
            if (0 == scope) {
        		...
        		$("can_create_urlkey").disabled = false;
            } else {
        		...
        		$("can_create_urlkey").selectedIndex = 0;
                $("can_create_urlkey").disabled = true;
            }
    ...
    protected function _prepareForm()
    {
		...
		*/
        ...
        $fieldSet->addField('custom_column_mapping', 'select', array(
            ...
            'value'    => 0,
            'onchange' => 'switchTabView(\'marginframe_dataflow_mapping\', this.value)',
        ));
        ...
        if (!Mage::app()->isSingleStoreMode()) {
            ...
            $fieldSet->addField('can_create_urlkey', 'select', array(
	            'name'     => 'can_create_urlkey',
	            'label'    => $this->__('Create URL Rewrite'),
	            'title'    => $this->__('Create URL Rewrite'),
	            'required' => true,
	            'options'  => array(
	                0 => $this->__('No'),
	                1 => $this->__('Yes'),
