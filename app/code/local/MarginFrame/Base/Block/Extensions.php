 ...
 */ 
class MarginFrame_Base_Block_Extensions extends Mage_Adminhtml_Block_System_Config_Form_Fieldset
{
    ...
    public function render(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        foreach ($modules as $moduleName) {
            if (strstr($moduleName, 'MarginFrame_') === false) {
            ...
            if ($moduleName == 'MarginFrame_Base'){
                continue;
            }
    ...
    protected function _getFieldHtml($fieldset, $moduleCode)
    {
        ...
        $allExtensions = MarginFrame_Base_Helper_Module::getAllExtensions();
