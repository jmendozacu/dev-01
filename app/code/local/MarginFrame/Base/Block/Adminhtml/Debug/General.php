 ...
 */ 
class MarginFrame_Base_Block_Adminhtml_Debug_General extends MarginFrame_Base_Block_Adminhtml_Debug_Base
{
    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('marginframe/ambase/debug/general.phtml');        
    }
