...
MarginFrame_Base_Helper_Module::baseModuleInstalled();

$feedData = array();
$feedData[] = array(
    'severity'      => 4,
    'date_added'    => gmdate('Y-m-d H:i:s', time()),
    'title'         => 'MarginFrame`s extension has been installed. Remember to flush all cache, recompile, log-out and log back in.',
    ...
    'url'           => 'http://marginframe.com/news/updates-and-notifications-configuration-9.html'
