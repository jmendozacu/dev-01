 ...
 */
    ...
    class MarginFrame_Base_Model_Conflict{
        ...
        protected function _createPureClass($class, $parentClasses, $classPath, $extends){
            ...
            $purePath = $classDir . DS . "MarginFrame". DS . "Pure.php";
            ...
            if (!file_exists($classDir . DS . "MarginFrame")){
                mkdir($classDir . DS . "MarginFrame");
                $this->_log("Dir created: " . $classDir . DS . "MarginFrame");
            }
        ...
        static function getPureClassName($class){
            return $class . '_MarginFrame_Pure';
        }
