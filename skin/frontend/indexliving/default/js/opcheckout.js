...
Shipping.prototype = {
    ...
    newAddress: function(isNew){
       ...
       $('shipping:mobile_customer').value='';
       $('shipping:country_id').value='';
       $('shipping:region_id').value='';
       $('shipping:city_id').value='';
       $('shipping:subdistrict_id').value='';
